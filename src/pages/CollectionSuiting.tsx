          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground">
                Discover our curated selection of premium wool, merino, and blended suiting fabrics for the modern executive
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="text-center">
                  <h3 className="font-display font-semibold text-lg mb-2">Expert Guidance</h3>
                  <p className="text-sm text-muted-foreground">
                    Personalized recommendations for your needs
                  </p>
                </div>
                <div className="text-center">
                  <h3 className="font-display font-semibold text-lg mb-2">Tailoring Support</h3>
                  <p className="text-sm text-muted-foreground">
